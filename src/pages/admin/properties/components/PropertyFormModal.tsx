          ...
          <div className="p-6 space-y-5">
            ...
            <div>
              ...
              <textarea rows={3} value={form.description}
                ...
                className="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-amber-500 resize-none"
                placeholder="Mô tả căn hộ..." maxLength={500} />
            </div>
